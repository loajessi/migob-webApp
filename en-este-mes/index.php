...
<div id="dContenido">
    ...
    <div class="w3-row-padding">
        <div id="sec_ListaUrlsCategoria" class="w3-twothird w3-container">
            <!-- Lista de Eventos -->
            <div id="spnTituloEventos" class="tituloSeccion w3-margin-left"></div>
            <hr class="w3-margin-left w3-theme-blue" style="height: 1px">
            <ul id="ulEnEsteMes" class="vinietaDocs"></ul>
            <hr class="w3-margin-left w3-theme-blue" style="height: 1px">
        </div>
    ...
    <input type="hidden" id="hdnAliasPaginaActual" name="hdnAliasPaginaActual" value="EV_MES"/>
</div>
